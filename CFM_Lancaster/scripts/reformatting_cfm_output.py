...
single_dimension_outputs = ['depth_lowest']#['delta_ele','cum_ele','tot_compaction','cum_tot_compaction']
ds_single_dimension_outputs = xr.concat([ds[single_dimension_outputs] for ds in ds_list], pd.Index(stations, name='station'))
ds_single_dimension_outputs.to_netcdf(f"{results_path}/Single_Dimension_CFM_Output.nc")